...
public class PickupActivity extends DasarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(sesi.isLogin()){
            ...
            if (networkinfo != null && networkinfo.isConnected()) {
                ...
                WebView myWebView = (WebView) findViewById(R.id.PickupView);
                myWebView.loadUrl("http://mobile.trisentrautama.com/pickup.php");

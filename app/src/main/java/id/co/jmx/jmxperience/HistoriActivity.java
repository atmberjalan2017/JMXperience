...
public class HistoriActivity extends DasarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(sesi.isLogin()){
            ...
            if (networkinfo != null && networkinfo.isConnected()) {
                ...
                WebView myWebView = (WebView) findViewById(R.id.HistoriView);
                myWebView.loadUrl("http://mobile.trisentrautama.com/histori.php");

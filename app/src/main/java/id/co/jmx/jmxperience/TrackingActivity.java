...
public class TrackingActivity extends DasarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(sesi.isLogin()){
            ...
            if (networkinfo != null && networkinfo.isConnected()) {
                ...
                WebView myWebView = (WebView) findViewById(R.id.TrackingView);
                myWebView.loadUrl("http://mobile.trisentrautama.com/tracking.php");
